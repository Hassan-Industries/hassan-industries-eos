...
interface EGLDocumentViewerShellProps {
...
export default function EGLDocumentViewerShell({
  publication,
}: EGLDocumentViewerShellProps) {
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-[12px] leading-5 text-slate-200">
                    Frontend viewer shell for controlled publications,
                    certified copies, source files, and future Microsoft 365 or
                    SharePoint document preview integrations.
                  </p>
                </div>
            ...
            <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
              <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 p-4">
                  <div className="flex min-h-[620px] flex-col items-center justify-center rounded-lg border border-slate-200 bg-white text-center">
                    <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-slate-950">
                      <FileText className="h-10 w-10 text-amber-400" />
                    </div>

                    <h3 className="mt-5 text-lg font-extrabold text-slate-950">
                      Document preview pending integration.
                    </h3>

                    <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600">
                      This viewer shell reserves the controlled viewing area for
                      future PDF preview, Office document preview, internal file
                      storage, SharePoint embed, or Microsoft 365 viewer
                      integration.
                    </p>

                    <div className="mt-6 grid gap-2 text-left text-xs text-slate-600 sm:grid-cols-2">
                      <ViewerCapability>PDF preview container</ViewerCapability>
                      <ViewerCapability>Office document preview</ViewerCapability>
                      <ViewerCapability>Certified copy display</ViewerCapability>
                      <ViewerCapability>Access-controlled viewing</ViewerCapability>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <aside className="space-y-4">
                ...
                <section className="rounded-lg border border-dashed border-slate-300 bg-white p-5 shadow-sm">
                  ...
                  <p className="text-xs leading-5 text-slate-600">
                    This viewer is intentionally frontend-only. It prepares the
                    interface for future document preview, employee training,
                    executive review, file access controls, upload routing,
                    download controls, Microsoft 365, and SharePoint-backed
                    viewing.
                  </p>
                </section>
              </aside>
...
function ViewerCapability({ children }: { children: ReactNode }) {
  return (
