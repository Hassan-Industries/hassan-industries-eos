...
interface EGLReviewRequestShellProps {
...
const reviewSteps = [
  "Confirm controlled record",
  "Select review reason",
  "Assign reviewer or department",
...
export default function EGLReviewRequestShell({
  publication,
}: EGLReviewRequestShellProps) {
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-[12px] leading-5 text-slate-200">
                    Frontend review-routing shell for controlled publications,
                    administrative review, governance review, treasury/legal/tax
                    review, and future executive approval workflows.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-3 text-xs leading-5 text-slate-600">
                        This page prepares the review request workflow before
                        backend routing is implemented. Later releases should
                        connect this shell to reviewer assignment, comments,
                        due dates, approval outcomes, and queue tracking.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-[13px] font-bold uppercase tracking-[0.18em] text-slate-950">
                        Review Request Workspace
                      </h2>

                      <p className="mt-1 text-xs text-slate-500">
                        Frontend placeholder for future reviewer assignment and
                        routing form.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 p-5">
                    <div className="grid gap-3 md:grid-cols-2">
                      <ReviewField label="Document Number" value={documentNumber} />
                      <ReviewField label="Owner" value={record.owner ?? "HCA"} />
                      <ReviewField
                        label="Current Status"
                        value={record.status ?? "AP"}
                      />
                      <ReviewField
                    ...
                    <div className="mt-5 rounded-lg border border-slate-200 bg-white p-5 text-center">
                      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-xl bg-slate-950">
                        <MessageSquareText className="h-7 w-7 text-amber-400" />
                      </div>

                      <p className="mt-4 text-sm font-extrabold text-slate-950">
                        Review request form pending backend integration.
                      </p>

                      <p className="mt-2 text-xs leading-5 text-slate-600">
                        This area will later hold reviewer assignment,
                        instructions, due dates, comments, and workflow
                        submission controls.
                      </p>
                    </div>
                  </div>
              ...
              <aside className="space-y-4">
                ...
                <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <ul className="space-y-2 text-xs leading-5 text-slate-600">
                    <li>• Review request is frontend-only in this phase.</li>
                    <li>• No reviewer is assigned yet.</li>
                    <li>• No workflow queue is updated yet.</li>
                    <li>• No approval decision is recorded yet.</li>
                    <li>• Future backend work will create review tasks.</li>
                  </ul>
                </section>
                ...
                <section className="rounded-lg border border-dashed border-slate-300 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-3 text-xs leading-5 text-slate-600">
                    In future training materials, this page should be described
                    as the controlled intake point for requesting publication
                    review. Review routing should later connect to queues,
                    assigned owners, due dates, comments, approvals, and
