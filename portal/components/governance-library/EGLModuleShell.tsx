            ...
            <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_340px]">
                  ...
                  <table className="w-full border-collapse text-xs">
                    <thead className="bg-slate-50">
                      <tr className="border-b border-slate-200 text-left uppercase tracking-[0.1em] text-slate-500">
                        <th className="px-3 py-3 font-bold">Record ID</th>
              ...
              <aside className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-[13px] font-bold uppercase tracking-[0.16em] text-slate-950">
                      Implementation Notes
                    </h2>

                    <p className="mt-1 text-[11px] text-slate-500">
                      Frontend shell prepared for backend integration.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  {module.plannedActions.map((action) => (
                    <div
                      key={action}
                      className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-xs leading-5 text-slate-700"
                    >
                      {action}
                    </div>
                  ))}
                ...
                <Link
                  href={module.route}
                  className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-slate-950 px-4 py-3 text-xs font-bold text-white transition hover:bg-slate-800"
                >
