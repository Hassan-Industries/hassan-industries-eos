        ...
        <div className="min-w-0 space-y-6">
          <section className="rounded-xl border border-[#d8e1ea] bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <QueueField label="Escalation Path" value={queue.escalationPath} />
            </div>
          </section>
        ...
        <aside className="space-y-5">
          <section className="rounded-xl border border-[#d8e1ea] bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-3">
              ...
              <button type="button" className="service-button w-full">
                Assign Queue Owner
              </button>
              <button type="button" className="service-button w-full">
                Review Queue SLA
              </button>
              <button type="button" className="service-button-warning w-full">
