...
export default function CertifiedCopiesRegistryPage() {
  const [selectedCopy, setSelectedCopy] = useState<CertifiedCopyRecord | null>(
    null,
  );
                ...
                <div className="flex flex-col gap-4 border-b border-slate-200 px-5 py-5 md:flex-row md:items-start md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
                      Select a certified copy record to preview source authority,
                      lifecycle status, source location, and future issuance
                      controls.
                    </p>
                  </div>
            ...
            <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_380px]">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-600">
                      ...
                      certification logs, generated certified-copy packets,
                      source file verification, issuing authority,
                      employee/executive access controls, and permanent
                      recordkeeping.
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-lg border border-dashed border-slate-300 bg-white p-5 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  ...
                  controlled evidence copies. Future backend work should connect
                  this registry to original executed locations, certification
                  authority, issue logs, download controls, and audit history.
                </p>
              </div>
            </section>
          </div>
...
function StatusBadge({ status }: { status: CertifiedCopyRecord["status"] }) {
    ...
    <aside className="min-w-0 overflow-hidden rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Select a certified copy record to open source authority,
            certification metadata, lifecycle status, and available
            certified-copy actions.
          </p>
        </div>
      ...
      <div className="mt-6 rounded-lg bg-slate-950 p-5 text-white">
        ...
        <p className="mt-2 text-xs leading-5 text-slate-200">
          Certified-copy controls open only after intentional certified-copy
          record selection.
        </p>
      </div>
    ...
    <aside className="min-w-0 overflow-hidden rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm font-black">{record.title}</p>
        </div>
      ...
      <div className="mt-5 space-y-2">
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-950 bg-slate-950 px-4 py-3 text-xs font-bold text-white transition hover:bg-slate-800"
        >
