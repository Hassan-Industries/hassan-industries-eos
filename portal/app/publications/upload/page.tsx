...
const workflowSteps = [
  ...
  "Select publication series or record relationship",
  "Attach draft, source, executed, or supporting file",
  "Confirm owner, authority, and classification",
  "Submit for administrative review",
  "Route to publication, replacement, certification, or filing queue",
];

const checklistItems = [
  "Upload purpose identified",
  "Record relationship prepared",
  "Owner and authority confirmed",
  "Classification selected",
  "Retention category considered",
  "Backend storage location reserved",
];

export default function EGLUploadDocumentPage() {
  return (
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-5xl text-sm leading-6 text-slate-100">
                    Frontend intake shell for submitting draft documents, source
                    files, executed records, supporting materials, replacement
                    candidates, and future controlled Enterprise Governance
                    Library uploads.
                  </p>
                </div>
            ...
            <section className="grid gap-4 xl:grid-cols-[1fr_390px]">
              <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-3 max-w-4xl text-sm leading-6 text-slate-600">
                        This shell prepares the future intake area for uploading
                        files into EGL workflows. No file is uploaded yet, no
                        record is created yet, and no backend storage location is
                        assigned in this frontend phase.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section className="grid gap-4 lg:grid-cols-2">
                  <WorkflowPanel title="Upload Steps" items={workflowSteps} />
                ...
                <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="mb-4 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-600">
                        Frontend placeholder for future file selection, metadata,
                        classification, routing, and storage controls.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 p-5">
                    <div className="grid gap-3 md:grid-cols-2">
                      <FieldCard label="Upload Type" value="Select Upload Type" />
                      <FieldCard label="Related Record" value="Optional / Select Record" />
                      <FieldCard label="Publication Series" value="Select Series" />
                      ...
                      <FieldCard label="Storage Location" value="Pending Backend Assignment" />
                    </div>
                    ...
                    <div className="mt-5 rounded-lg border border-slate-200 bg-white p-8 text-center">
                      ...
                      <h3 className="mt-4 text-lg font-black text-slate-950">
                        Document upload form pending backend integration.
                      </h3>

                      <p className="mx-auto mt-2 max-w-3xl text-sm leading-6 text-slate-600">
                        This area will later hold file picker controls, upload
                        validation, Microsoft 365 or SharePoint storage,
                        document metadata, access controls, workflow routing,
              ...
              <aside className="space-y-4">
                ...
                <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <ul className="space-y-3 text-sm leading-6 text-slate-600">
                    <li>• Upload workflow is frontend-only in this phase.</li>
                    <li>• No file is uploaded yet.</li>
                    <li>• No backend record is created yet.</li>
                    <li>• No storage location is assigned yet.</li>
                ...
                <section className="rounded-lg border border-dashed border-slate-300 bg-white p-5 shadow-sm">
                  ...
                  <p className="text-sm leading-6 text-slate-600">
                    ...
                    page should be described as the controlled intake point for
                    submitting files into EGL workflows. The final backend
                    version should require role-based access, metadata capture,
                    classification, approval routing, file storage, and
